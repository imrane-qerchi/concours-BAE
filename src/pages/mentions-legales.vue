      ...
      <section class="space-y-8 text-black text-lg font-light leading-relaxed">
        ...
        <div>
          ...
          <p class="mt-2">
            ...
            universitaire 2025-2026. Le tirage au sort désignant les gagnants est effectué
            manuellement par l’équipe organisatrice.
          </p>
          <p class="mt-2">
            La participation au concours implique l’acceptation tacite du règlement, sans nécessité
